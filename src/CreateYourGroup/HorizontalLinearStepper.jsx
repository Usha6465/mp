      ...
      case 0:
        return (
          <div style={{ width: "70%", margin: "auto",textAlign:"left" }}>
            ...
            <p>
              Hear ME Out groups meet locally, in person and online. We'll connect you
            ...
            Work friendships don’t need to fade just because you’re working remotely. Here are three fun ways you can get to know your colleagues. Reduce stress, improve your mood, and connect with others by pursuing your new artistic hobby through Hear Me Out.</p>
      ...
      case 2:
        return (
          <div style={{ width: "70%", margin: "auto",textAlign:"left" }}>
            ...
            <p>
              Hear Me Out is all about helping people live fuller, happier lives—with
            ...
            <p>
              Once you submit your group, a human at Hear Me Out will review it based
